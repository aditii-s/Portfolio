...
<html lang="en">
    <head>
        ...
        <meta charset="UTF-8">
        <meta name="description" content="Responsive Hod Dashboard Template" />
                ...
                <table id="example" class="display responsive-table">
                    <thead>
                        <tr>
                            ...
                            <th width="165">Leave Type</th>
                            <th width="180">Posting Date</th>
                            <th width="200">Status</th>
                            <th width="120">Proof</th>
                            <th width="150">Substitute Emp</th>
                    ...
                    <tbody>
                        ...
                        $sql = "SELECT tblleaves.id as lid, 
                                       ...
                                       tblleaves.Status, 
                                       tblleaves.Proof, 
                                       COALESCE((SELECT CONCAT(sub.FirstName, ' ', sub.LastName) 
                                                 FROM tblemployees sub 
                                                 JOIN tblclassrequests cr ON sub.id = cr.requested_emp_id 
                                                 WHERE cr.status = 'Accepted' AND cr.requester_id = tblemployees.id AND cr.from_date = tblleaves.FromDate LIMIT 1), 'No Substitute') AS SubstituteTeacher
                                FROM tblleaves 
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo htmlentities($result->SubstituteTeacher); ?>
                                    </td>
                                    <td>
